...
class FlightPlanEventListener(EventListener["FlightPlan"]):
    ...
    async def on_flightplan_simulation_start(self, server: Server, data: dict) -> None:
        """Handle the flightplanSimulationStart event from Lua callbacks."""
        # This is triggered when a mission starts - same functionality as onSimulationStart
        await self.on_simulation_start(server, data)
